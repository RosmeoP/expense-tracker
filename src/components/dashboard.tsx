...
const Dashboard = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="theme-amount-negative text-lg">{error}</p>
          <button 
  ...
  return (
    <>
      ...
      {user && showWelcome && (
        <div className="fixed top-6 right-6 z-50 theme-card backdrop-blur-sm theme-border border shadow-2xl rounded-2xl p-5 transition-all duration-500 transform animate-in slide-in-from-right-5 hover:scale-105">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <h3 className="text-base font-bold theme-text">Welcome back!</h3>
            ...
            <button 
              ...
              className="flex-shrink-0 p-1 theme-text-secondary hover:theme-text hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all duration-200"
      ...
      <Layout>
        <div className="space-y-6">
          ...
          <div className="text-center mb-8">
            ...
            {user && (
              <div className="inline-flex items-center gap-2 px-4 py-2 theme-gradient rounded-full theme-border border">
                <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <p className="text-sm font-medium theme-amount-primary">
                  Welcome, {user.name}
                </p>
              </div>
            )}
